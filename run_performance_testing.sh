...
benchmark_branch () {
    ...
    cd $pathtotop
    g++ math-microbenchmark/$testfile.cpp math-microbenchmark/$inputfile.cpp -DBRANCH=$branch -std=c++1y -D_REENTRANT -Wno-sign-compare -isystem benchmark/include -Lbenchmark/build/src -lbenchmark -lpthread -I math/lib/tbb_2019_U8/include -O3 -I math/ -I math/lib/eigen_3.3.3 -I math/lib/boost_1.69.0 -I math/lib/sundials_4.1.0/include -DBOOST_DISABLE_ASSERTS  -Wl,-L,"math/lib/tbb" -Wl,-rpath,"math/lib/tbb" math/lib/tbb/libtbb.so.2  math/lib/sundials_4.1.0/lib/libsundials_nvecserial.a math/lib/sundials_4.1.0/lib/libsundials_cvodes.a math/lib/sundials_4.1.0/lib/libsundials_idas.a math/lib/sundials_4.1.0/lib/libsundials_kinsol.a -o $testfile
    chmod +777 $testfile
    ./$testfile
    rm $testfile
}
